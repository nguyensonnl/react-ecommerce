...
const BRK = () => {
  return (
    <div className="container">
      ...
      <div>
        Vào ngày nn vào luc aabb, tôi có khai thác chuyến bay SQ184 Trong quá
        trình khai thác, lô hàng có cargo label với số MAWB: và HAWB: tôi đã
        không kiểm tra kỹ cargo label của từng kiện nên đã không phát hiện ra có
        1 kiện có cargo label với MAWB: và HAWB: khắc biệt so với trên hệ thống,
        kết quả là lô hàng này đã bị MSCA 1 kiện và FDCA 1 kiện DEST SGN, do
        không phát hiện sớm và không thông báo sớm cho hãng để giải quyết nên đã
        ảnh hưởng rất nhiều trong quá trình lưu kho và phát hàng cho khách.
      </div>
